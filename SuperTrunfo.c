...
int main() {
    ...
    // Acima coloquei todas as variáveis utilizadas para as cartas 1 e 2.
    //Abaixo coloquei printf/scanf para coletar e mostrar os dados da carta 1.
    ...
    /* Abaixo comecei com a parte intermediária do desafio.
    ...
    /* Abaixo Comecei com a parte intermediária do desafio.
    Calculando a densidade populacional e o pib per capita da carta 2 Abaixo. */
    ...
    // comparação das duas cartas, atributo por atributo.
